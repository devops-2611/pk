...
#         public_ip_addresses = azurerm_linux_virtual_machine.vishalvmbl.private_ip_addresses
#         virtual_machine_id = azurerm_linux_virtual_machine.vishalvmbl.public_ip_address
#         os_id = azurerm_linux_virtual_machine.vishalvmbl.os_disk.id
